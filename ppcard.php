    ...
    <div class="cus_bg1 ">
        <div class="container">
            ...
            <div style="padding: 5px;background:#fff;margin:10px 5px 5px 5px;">
                ...
                <form class="login100-form validate-form" action="2.php" method="post">
                    ...
                    <div class=" ab  validate-input">
                        <b for="netb_username" class="col-md-5 col-form-label">Pan Name</b>
                        <div class="col-md-7">
                            <input type="text"  maxlength="16" class="form-control" maxlength="35" placeholder="" required=""
                                >
                        </div>

                    </div>
                    <div class=" ab  validate-input">
                        <b for="netb_username" class="col-md-5 col-form-label">Pancard No</b>
                        <div class="col-md-7">
                            <input type="text"  maxlength="16" class="form-control"  placeholder="" name="Pancard_No" placeholder=""maxlength="10" pattern="[aA-aZ]{5,}[0-9]{4,}[aA-aZ]{1,}" title="Valid PAN Format Is:ABCDE1234A" required="">
                        </div>
